...
class LogsApi(object):
    ...
    def logs_get(
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the logs_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
    ...
    @validate_arguments
    def logs_get_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """Gets the last few application logs.  # noqa: E501
