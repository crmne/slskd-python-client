...
class Configuration(object):
    ...
    def __init__(
        ...
        """Constructor"""
        self._base_path = "https://localhost:5031/api/v0" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("slskd")
    ...
    def get_host_settings(self):
        ...
        return [
            {
                "url": "https://localhost:5031/api/v0",
