...
class FiltersOptions(BaseModel):
    """
    Filter options.
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FiltersOptions:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FiltersOptions:
        """Create an instance of FiltersOptions from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FiltersOptions.parse_obj(obj)

        _obj = FiltersOptions.parse_obj(
            {
                "search": SearchOptions.from_dict(obj.get("search"))
