...
import slskd.models
from slskd import rest
from slskd.api_response import ApiResponse
from slskd.configuration import Configuration
from slskd.exceptions import ApiException, ApiValueError
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(slskd.models, klass)
